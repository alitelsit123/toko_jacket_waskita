...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2023 at 04:28 PM
...
(23, 'Hoodie', 700, 7, 1, 2, 2, 2, 'xxxxx xxxx xxxx x x x x xxxx', '1nofoto.jpg', 700),
...
(28, 'jaket brewok', 1234567, 9, 1, 3, 3, 2, 'asdfasdfasdfasdfasdfasdf', 'Picture1.jpg', 123);
...
(91, '202301151QZLREKB', 28, 1, 'XL'),
(92, '20230115FRCSQOHJ', 23, 1, 'S'),
(93, '20230115QJV1OI7C', 28, 2, 'S');
...
(1, 'Black Market', 33719, 'jalan palagan km 90', '081226931079');
...
--
ALTER TABLE `tbl_barang`
  MODIFY `id_barang` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `tbl_gambar`
--
ALTER TABLE `tbl_gambar`
  MODIFY `id_gambar` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `tbl_rinci_transaksi`
  MODIFY `id_rinci` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
